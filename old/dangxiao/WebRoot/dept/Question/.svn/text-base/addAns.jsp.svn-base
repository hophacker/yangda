...
<%
	request.setCharacterEncoding("GBK");
	String result = Question.addOneAns(request.getParameter("que"), request.getParameter("ans"), request.getParameter("deg"));
	response.setHeader("Refresh", "0;URL = ../SeaAnsQue.jsp");
