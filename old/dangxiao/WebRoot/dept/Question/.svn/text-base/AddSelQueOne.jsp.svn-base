...
<%
	request.setCharacterEncoding("GBK");
	String result;
	result = Question.addOneSel(request.getParameter("sinque"),
	request.getParameter("sela"), request.getParameter("selb"), request.getParameter("selc"), request.getParameter("seld"), 
	request.getParameter("chos"), request.getParameter("deg"));
